...
python3 ./main/test.py --config 'experiments/siamfcpp/test/siamfcpp_tinyconv.yaml'
python3 ./main/test.py --config 'experiments/siamfcpp/test/siamfcpp_tinyconv-multi_temp.yaml'
