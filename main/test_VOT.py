...
tracker_cfg_path = osp.join(root_path, 'experiments/siamfc++/siamfcpp_alexnet.yaml')
...
def make_parser():
    ...
    parser.add_argument('--videos', nargs='*', type=str, default=[], help='Save a given set of videos')
    parser.add_argument('--inference', action='store_true', help='True: tracking; False: donnot tracking')
    parser.add_argument('--evaluation', action='store_true', help='True: eval; False: donnot eval')
